...
if not os.path.isfile(image_file):
    url = "https://upload.wikimedia.org/wikipedia/commons/c/c7/Abbey_Road_Zebra_crossing_" \
          "2004.jpg"
    r = requests.get(url)
...
cv2.imshow("Object detection", image)  # google colab: utiliser cv2.imread( 'Object detection, cv2_imshow(image))
cv2.waitKey()